...
run_in_tempdir {
    ...
    ok $needinfo_status_id, 'new project inserted issue_status needinfo';
    ...
    my $sha1_hex =
      sha1_hex( 'issue', $mtime, $mtimetz, 'x', 'x', 'en', 'title', 'message',
      );
...
=cut
    ...
    is_deeply $db->selectrow_arrayref(
      ...
      [ $needinfo_status_id, $update_id, $needinfo_status_id ], 'issue_updates';
