...
exchanging updates with remote databases on demand.  This introduction
to bif is based on situations typically encountered by software
developers; It is assumed that you are comfortable working with command
line programs and your operating system shell (e.g. bash).

This document is based on bif version 0.1.0_26 (2014-07-23).
...
Need to register with an organisation's hub somewhere.

    #!sh
    bif register organisation@hub.com
...
L<bif>(1), L<bif-doc-faq>(1), L<bif-doc-toc>(1)
