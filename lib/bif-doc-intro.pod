...
exchanging updates with remote databases on demand.

The examples given in this introduction are based on project management
situations typically encountered by software developers.  It is assumed
that you are comfortable working with command line programs and your
operating system shell (e.g. bash).

=head1 Version

This document is based on bif version 0.1.0_25 (2014-06-14).
