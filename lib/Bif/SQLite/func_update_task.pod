...
inserting a row into L<task_updates|Bif::SQLite::table::task_updates>.
As it just passes the values straight through this function is possibly
...
=item * L<task_updates|Bif::SQLite::table::task_updates>

=back

=head1 SEE ALSO

L<Bif::SQLite::table::updates>, L<Bif::SQLite::table::tasks>,
