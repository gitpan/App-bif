...
In each repository we track the related hub_update,
hub_location_updates, project_updates and *_status_updates in the
"hub_related_updates" table.
...
project_updates and *_status_updates in the "hub_related_updates"
table.
