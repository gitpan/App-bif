...
inserting a row into each of the L<topics|bif-sql-table-topics> and
L<projects|bif-sql-table-projects> tables.

The transaction will fail with a foreign key violation unless at least
one call to
L<func_new_project_status()|bif-sql-func-new-project-status> is also
made and a row is inserted into
L<project_updates|bif-sql-table-project-updates> resulting in
...
=item * L<topics|bif-sql-table-topics>

=item * L<projects|bif-sql-table-projects>

=back

=head1 SEE ALSO

L<bif-sql-table-updates>, L<bif-sql-table-topics>,
L<bif-sql-table-projects>, L<bif-sql-func-new-project-status>,
L<bif-sql-table-project-updates>, L<bif-sql-func-merge-updates>
